...
import {
  ...
  Cpu, Database, Cloud, Layers, Globe, Zap
} from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="True North IT Solutions architects high-performance global digital infrastructure and software. Scalable SaaS, Cloud Native architectures, and SLA-backed engineering." />
              ...
              <div className="glass rounded-3xl p-7 relative overflow-hidden shadow-2xl">
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div className="border-x border-border-subtle">
                    ...
                    <p className="text-[10px] text-text-secondary mt-0.5 uppercase tracking-wider">Clients</p>
                  </div>
                  <div>
