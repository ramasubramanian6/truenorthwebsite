...
const PrivacyPolicy = () => {
  return (
    <div className="pt-20 pb-24">
      <Helmet>
        <title>Privacy Policy | True North IT Consultancy</title>
        <meta name="description" content="Privacy Policy and Data Protection guidelines for True North IT Consultancy." />
      </Helmet>
      ...
      <section className="container mx-auto px-6 max-w-4xl">
        ...
        <AnimatedSection delay={0.1} className="glass p-8 md:p-12 rounded-3xl border border-border-subtle prose prose-invert max-w-none">
          ...
          <p className="text-text-secondary leading-relaxed mb-6">
            When you engage with True North IT Consultancy, we may collect personal information such as your name, email address, company details, and phone number via our contact forms. We also automatically collect standard analytics data (IP address, browser type, pages visited) to improve our service quality.
          </p>
