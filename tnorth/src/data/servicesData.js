export const servicesData = [
  {
    ...
    features: [
      ...
      'SEO-Optimised, Performance-Tuned Codebase',
      'Progressive Web App (PWA) Development',
      'E-Commerce & Portal Solutions',
    ],
    benefits: [
      'Scalable Systems Built for Global Growth',
    ...
    process: ['Discovery & Scope', 'UI/UX Design', 'Agile Development', 'QA & Testing', 'Launch & Support'],
    outcome: 'Scalable, Revenue-Generating Digital Products',
    icon: 'Monitor',
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          'Absolutely. We handle full-cycle development — from concept and UI/UX design through to deployment, monitoring, and ongoing maintenance.',
      },
      {
        question: 'Do you work with startups as well as enterprises?',
        answer:
          'Yes. We partner with startups, SMEs, and large-scale enterprises, applying the same rigorous engineering standards to every project regardless of company size.',
      },
    ],
  },
  {
    ...
    features: [
      ...
      'Automated Test Suites (Cypress, Playwright, Selenium)',
    ...
    benefits: [
      ...
      'Faster Release Cycles via Automation',
      'Enhanced User Trust & Satisfaction',
      'Reduced Post-Launch Hotfix Costs',
      'Global Compliance Readiness',
    ],
    process: ['Test Strategy', 'Test Case Design', 'Execution & Automation', 'Bug Reporting', 'Sign-Off & Certification'],
    outcome: 'Error-Free, Secure, Production-Ready Software',
    icon: 'ShieldCheck',
    faqs: [
      {
        question: 'Can you integrate QA into our existing development team?',
        answer:
          'Yes. We offer embedded QA models, standalone testing engagements, and full QA-as-a-Service depending on your team structure and release cadence.',
      },
      {
        question: 'Do you provide security testing for applications?',
        answer:
          'Yes. Our security testing service includes OWASP Top 10 vulnerability assessments, penetration testing, and data exposure audits — critical for businesses handling sensitive global data.',
      },
      {
        question: 'How quickly can you start a testing engagement?',
        answer:
          'Most engagements begin within 5 business days. We onboard rapidly and align with your international sprint schedule from day one.',
      },
    ],
  },
  {
    ...
    features: [
      ...
      'Rapid Incident Response & Escalation Management',
      'Scheduled Preventive Maintenance',
      'Security Patch & Update Management',
      'Cloud Infrastructure Management (AWS, GCP, Azure)',
      'SLA-Backed Service Contracts',
      'Monthly Health & Performance Reporting',
    ],
    benefits: [
      'Near-Zero Downtime',
      'Proactive Issue Prevention',
      'Reduced Operational Risk',
      'Predictable IT Costs via SLA',
      'Access to Senior Engineers On-Demand',
      'Global Business Continuity Assurance',
    ],
    process: ['SLA Design', 'Monitoring Setup', 'Proactive Detection', 'Rapid Resolution', 'Reporting & Review'],
    outcome: 'Continuous, Uninterrupted Business Operations',
    icon: 'Headphones',
    faqs: [
      {
        question: 'Do you provide support for cloud-hosted systems?',
        answer:
          'Yes. We manage applications and infrastructure hosted on AWS, Google Cloud, Azure, and private servers — providing unified support regardless of your global hosting environment.',
      },
      {
        question: 'What does your SLA guarantee?',
        answer:
          'Our SLAs typically guarantee response times within 1–4 hours based on severity tier, with resolution targets of 24–72 hours. Custom SLAs are available for enterprise clients.',
      },
      {
        question: 'Is your support team available across all timezones?',
        answer:
          'Yes. We provide 24/7 follow-the-sun support to ensure that assistance is always available regardless of your geographical location.',
      },
    ],
  },
  {
    ...
    features: [
      ...
      'Technology Audit & Infrastructure Assessment',
      'CRM, ERP & Enterprise Software Implementation',
      'Cloud Migration & Architecture Design',
      'Vendor Selection & Technology Procurement',
      'Change Management & Staff Training',
      'Post-Implementation Optimisation & Support',
    ],
    benefits: [
      'Strategic Technology Alignment with Business Goals',
      'Reduced Implementation Risk & Cost Overruns',
      'Faster Time-to-Value on Technology Investments',
      'Streamlined, Automated Business Operations',
      'Scalable Architecture for Future Growth',
      'Expert Guidance from Senior Technology Leaders',
    ],
    process: ['Discovery & Assessment', 'Strategy & Roadmap', 'Architecture Design', 'Implementation & Integration', 'Review & Optimisation'],
    outcome: 'Technology-Powered Business Growth',
    icon: 'Rocket',
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          'Yes. Our technology audit and vendor selection service evaluates your requirements against global market solutions and recommends the best-fit tools.',
      },
      {
        question: 'Do you support organisations outside India?',
        answer:
          'Yes. We regularly engage clients in North America, Europe, and the Middle East. Our consulting model is designed for remote-first, timezone-flexible delivery.',
      },
    ],
  },
];
